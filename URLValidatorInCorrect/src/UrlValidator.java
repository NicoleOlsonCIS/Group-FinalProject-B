...
public class UrlValidator implements Serializable {
    ...
    private static final int MAX_UNSIGNED_16_BIT_INT = 0x320; // port max #bug #1 changed from FFFF which is 65535 to 800 in hexadecimal
    ...
    public boolean isValid(String value) {
        ...
        if ("file".equals(scheme)) {// Special case - file: allows an empty authority
            ...
            if (!isValidAuthority(authority)) { //bug3 should be !isValidAuthority
                return false;
            }
        }
